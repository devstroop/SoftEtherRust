...
int main() {
  const char* json = "{\"server\":\"127.0.0.1\",\"port\":443,\"hub\":\"DEFAULT\",\"username\":\"user\",\"password\":\"pass\",\"use_encrypt\":true,\"use_compress\":false,\"max_connections\":1,\"skip_tls_verify\":true}";
